...
import cn.schoolwow.quickdao.h2.entity.*;
...
/**配置项测试*/
public class ConfigTest extends H2Test {
    /**
     * 测试实体类扫描
     * */
    @Test
    ...
    public void testGenerateEntityFile() throws IOException {
        DAO dao = QuickDAO.newInstance()
                ...
                .build();
        String directory = System.getProperty("user.dir")+"/h2/";
