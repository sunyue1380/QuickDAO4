package cn.schoolwow.quickdao.oracle;
...
import cn.schoolwow.quickdao.oracle.entity.Product;
...
public class OracleTest extends DatabaseTest {
    static{
        dataSource = DAOUtil.getOracleDataSource();
        dao = DAOUtil.getOracleDAO(dataSource);
    }
    ...
    public void initializePersonAndOrder(){
