...
import cn.schoolwow.quickdao.mariadb.entity.DownloadTask;
import cn.schoolwow.quickdao.mariadb.entity.Order;
import cn.schoolwow.quickdao.mariadb.entity.Person;
import cn.schoolwow.quickdao.mariadb.entity.TypeEntity;
...
/**配置项测试*/
public class ConfigTest extends MariaDBTest {
    /**
     * 测试实体类扫描
     * */
    @Test
    ...
    public void testGenerateEntityFile() throws IOException {
        DAO dao = QuickDAO.newInstance()
                ...
                .build();
        String directory = System.getProperty("user.dir")+"/mariadb/";
